...
class AccountStmt(models.TransientModel):
    _name = 'account.stmt'
    ...
    @api.onchange('account_id', 'from_date', 'to_date', 'branch_id')
    ...
    def print_reports(self):
        return self.env.ref('enz_bank_cash_adjustment.accountstmt_report_id').report_action(self)
